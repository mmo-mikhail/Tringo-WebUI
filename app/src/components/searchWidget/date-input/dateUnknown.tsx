            ...
            <div className='flexible-dates-main-area'>
                ...
                <div id='durationbtgroup' className='btn-group'>
                    <button
                        ...
                        className={Duration[this.state.durationOption] === Duration[Duration.Weekend]
                            ? 'btn-selection' : 'btn-standard'}
                        onClick={(event: React.MouseEvent<HTMLElement>) => {
                            this.handleClick(event);
                        }}
                    >
                    ...
                    <button
                        ...
                        className={Duration[this.state.durationOption] === Duration[Duration.Week]
                            ? 'btn-selection' : 'btn-standard'}
                        onClick={(event: React.MouseEvent<HTMLElement>) => {
                            this.handleClick(event);
                        }}
                    ...
                    <button
                        ...
                        className={Duration[this.state.durationOption] === Duration[Duration.TwoWeek]
                            ? 'btn-selection' : 'btn-standard'}
                        onClick={(event: React.MouseEvent<HTMLElement>) => {
                            this.handleClick(event);
                        }}
